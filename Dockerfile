...
# nvidia-docker run -v /home/yba/GraphEmbedding:/workspace -it yba_graphembedding "cd src && ls"
# nvidia-docker run -v /home/yba/GraphEmbedding:/workspace --env CUDA_VISIBLE_DEVICES=_ yba_graphembedding
